...
This robotic arm is a 3-DOF (Degrees of Freedom) build.The structure is made using cardboard and ice sticks, keeping the design lightweight and cost-effective.The project name BONES is inspired by names from Iron Man comics.
...
#How It Works
The Python script sends joint angle values through the serial port.The Arduino reads these values and adjusts servo positions.The arm responds instantly to slider movements, enabling precise manual control.
